...
// -- Local modules
const ES6Pakket = require('../index.js')
    ;
...
describe('Test ES6Pakket:', () => {
  ...
  describe('Test ES6Pakket constructor and methods:', () => {
    const o = new ES6Pakket('name');

    it('Expects new ES6Pakket("name") to return an object.', () => {
